  ...
  useEffect(() => {
    ...
    getBlockdagInfo().then((blockdag) => {
      getBlock(blockdag.tipHashes[0]).then((block) => {
        setCurrentEpochTime(
          Math.round(parseInt(block.header.timestamp) / 1000)
        );
  ...
  return (
    <div className="addressinfo-page">
      <Container className="webpage addressinfo-box" fluid>
        <Row>
          <Col xs={12}>
            <div className="addressinfo-title d-flex flex-row align-items-end">
              address Overview
            </div>
          </Col>
        </Row>
        <Row>
          <Col md={12} className="mt-sm-4">
            ...
            <div className="utxo-value-mono">
              <span class="addressinfo-color">kaspa:</span>
            ...
            <div className="utxo-value d-flex">
              {addressBalance !== undefined ? (
                <div className="utxo-amount">
                  +{numberWithCommas(addressBalance / 100000000)} KAS
                </div>
              ) : (
        ...
        <Row>
          <Col sm={6} md={4}>
            <div className="addressinfo-header addressinfo-header-border mt-4 mt-sm-4 pt-sm-4 me-sm-5">
              value
            </div>
            <div className="utxo-value">
              {numberWithCommas(
                ((addressBalance / 100000000) * price).toFixed(2)
              )}{" "}
              USD
            </div>
          </Col>
        ...
        <Container className="webpage addressinfo-box mt-4" fluid>
          <Row className="border-bottom border-bottom-1">
            <Col xs={12} md={8} className="d-flex flex-column">
              <div className="utxo-title d-flex flex-row">
                Transactions History
              </div>
              <div className="d-flex flex-wrap flex-row align-items-center gap-3 pb-4">
                        ...
                        >
                          {getAmount(x.outputs, x.inputs) > 0 ? (
                            <span className="utxo-amount">
                              +
                              {numberWithCommas(
                                floatToStr(getAmount(x.outputs, x.inputs))
                              )}
                              &nbsp;KAS
                            </span>
                          ) : (
                    ...
                    <Row className="utxo-border pb-4 mb-4">
                      ...
                      <Col md={12}>
                        ...
                        >
                          ...
                          {x.is_accepted &&
                            blueScore !== 0 &&
                            blueScore - x.accepting_block_blue_score <
                              86400 && (
        ...
        <Container className="webpage addressinfo-box mt-4" fluid>
          <Row className="border-bottom border-bottom-1">
            <Col
              xs={12}
              md={8}
              className="d-flex flex-column align-items-start pb-4"
            >
            ...
            {utxos.length > 10 ? (
              ...
              >
                <UtxoPagination
                  active={active}
                  total={Math.ceil(utxos.length / 10)}
                  setActive={setActive}
                />
              </Col>
            ) : (
          ...
          {!loadingUtxos ? (
            utxos
              .sort(
                (a, b) => b.utxoEntry.blockDaaScore - a.utxoEntry.blockDaaScore
              )
                ...
                <>
                  <Row className="utxo-value text-primary mt-3">
                    <Col sm={7} md={7}>
                      {moment(
                        (currentEpochTime -
                          (currentDaaScore - x.utxoEntry.blockDaaScore)) *
                          1000
                  ...
                  <Row className="utxo-border pb-4 mb-4">
                    <Col sm={6} md={4}>
                      ...
                      <div className="utxo-value">
                        <Link
                          className="blockinfo-link"
                          to={`/txs/${x.outpoint.transactionId}`}
                        >
                    ...
                    <Col sm={6} md={4}>
                      ...
                      <div className="utxo-value d-flex flex-row">
                        <div className="utxo-amount">
                          +{numberWithCommas(x.utxoEntry.amount / 100000000)}{" "}
                          KAS
                        </div>
                      </div>
                    </Col>
                    <Col sm={6} md={4}>
                      ...
                      <div className="utxo-value">
                        {numberWithCommas(
                          ((x.utxoEntry.amount / 100000000) * price).toFixed(2)
                        )}{" "}
                        $
                      </div>
                    </Col>
