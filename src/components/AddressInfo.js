        ...
        <Row>
          <Col md={12} className="mt-sm-4">
            ...
            <div className="utxo-value-mono">
              <span class="addressinfo-color">{ADDRESS_PREFIX}</span>
            ...
            <div className="utxo-value d-flex">
              {addressBalance !== undefined ? (
                <div className="utxo-amount">
                  +{numberWithCommas(addressBalance / 100000000)} {KASPA_UNIT}
                </div>
              ) : (
          ...
          <Row className="border-bottom border-bottom-1">
            ...
            {utxos.length > 10 ? (
              <Col
                xs={12}
                sm={11}
                className="d-flex flex-row justify-items-end"
              >
                <UtxoPagination
                  active={active}
